...
public interface SysActivityMapper extends BaseMapper<SysActivity> {
    ...
    IPage<SysActivity> findAll(@Param("criteria") SysActivityQueryCriteria criteria, Page<Object> page);

    List<SysActivity> findAll(@Param("criteria") SysActivityQueryCriteria criteria);
}